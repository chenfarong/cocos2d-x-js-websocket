...
cc.Class({
    ...
    netEvent: function netEvent(msg, target) {
        ...
        if (msg.cmd == _Opcodes.xx_opcodes.XC_NET_DISCONNECTED) {
        ...
        if (labelNode) {
            ...
            if (label) {
                ...
                if (msg.cmd == _Opcodes.xx_opcodes.XC_NET_CONNECTED) {
                    label.string = "连接成功";
                    return;
                }
    ...
    onDestroy: function onDestroy() {
        _Network.XNet.ListenerRemove(_Opcodes.xx_opcodes.SC_SYS_INFO, this.myListener1);
    },
    ...
    onLoad: function onLoad() {
        ...
        */
        ...
        _Network.XNet.ListenerAdd(_Opcodes.xx_opcodes.SC_SYS_INFO, this.myListener1);
        _Network.XNet.ListenerAdd(_Opcodes.xx_opcodes.XC_NET_CONNECT_TIMEOUT, this.myListener1);
        _Network.XNet.ListenerAdd(_Opcodes.xx_opcodes.XC_NET_ERROR, this.myListener1);
        _Network.XNet.ListenerAdd(_Opcodes.xx_opcodes.XC_NET_DISCONNECTED, this.myListener1);
